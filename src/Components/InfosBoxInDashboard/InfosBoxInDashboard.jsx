...
const InfosBox = ({ title, count, icon, color }) => {
    return (
      <div
        className={`${color} flex items-center gap-x-2.5 md:gap-x-4 flex-grow md:flex-grow-0 md:max-w-72 p-2 rounded-2xl`}
      >
        ...
        <div className="flex flex-col gap-y-1.5 md:gap-y-2 text-white">
          <span className="font-MorabbaBold text-base">{title} </span>
