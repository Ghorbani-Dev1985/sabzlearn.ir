...
function LoginRegister() {
  return (
    <div className='relative text-base xl:text-lg text-white md:h-14 md:w-[155px] xl:w-[180px]'>
      <Link to="/login" className='absolute right-0 w-25 xl:w-28 hidden md:flex items-center hover:text-white justify-start h-full bg-sky-500/50 hover:bg-sky-400 dark:bg-secondaryLight dark:hover:bg-secondary/60 rounded-full pr-5 transition-colors'>ورود</Link>
