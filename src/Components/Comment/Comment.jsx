...
function Comment({showNewCommentForm , setShowNewCommentForm , NewCommentHandler , comments}) {
  ...
  return (
    ...
    {/* Comment Items */}
    {
       comments.length > 0 ?  <div className="space-y-3.5 sm:space-y-5 ">
  ...
  </div> : <Alert severity="info" className='dark:bg-mainSlate dark:text-sky-500'>تاکنون نظری ثبت نگردیده است</Alert>
    }
