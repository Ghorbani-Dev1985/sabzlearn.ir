      ...
      <section className="flex-center gap-y-10 flex-wrap lg:flex-nowrap lg:flex-between text-center lg:text-right">
        <div className="w-full sm:w-auto order-2 lg:order-1">
          ...
          >
            ...
            <span className="block text-slate-500 dark:text-gray-500 text-right truncate">
              هدیه تخفیف بهمن ماه رو دیدی؟🌻
            </span>
          </Link>
          {/* Hero Text Section */}
          ...
          <div className="flex-center flex-wrap lg:justify-start gap-5 sm:gap-7 mt-6 sm:mt-10 lg:mt-12">
            <Link
              to="#"
              className="flex-center button-md sm:button-lg button-secondary rounded-full"
            >
              از اینجا شروع کن
            </Link>
            <Link
        ...
        <div className="order-1 lg:order-2">
          {colorTheme === "dark" ? (
            <img
              src={BoyLight}
              alt="ghorbani-dev.ir"
              className="w-full sm:w-[400px] lg:w-[460px] xl:w-[550px]"
            />
          ) : (
            <img
              src={BoyDark}
