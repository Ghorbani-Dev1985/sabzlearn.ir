      ...
      <section className="grid items-start grid-rows-1 lg:grid-cols-3 xl:grid-cols-4 gap-3.5 sm:gap-5 mt-12 sm:mt-25">
        ...
        <section className="col-span-1 lg:col-span-2 xl:col-span-3">
          ...
          </div>
          {
            ...
            <svg class="show-more__loading hidden w-6 h-6 animate-spin text-white dark:text-gray-600 fill-zinc-700 dark:fill-white" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
