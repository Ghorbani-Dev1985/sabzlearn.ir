    ...
    <>
      {isShowLoading ? (
        ...
        <>
         <div className='grid grid-rows-2 xs:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-5'>
              ...
              userCourses.map((course) => {
                ...
                return(
                  <React.Fragment key={course.course._id}>
                    ...
                    <a className="w-full h-full block" href="https://sabzlearn.ir/course/java-script-zero-to-hero/#lessons" title="آموزش جاوا اسکریپت رایگان مقدماتی تا پیشرفته + مینی پروژه">
            ...
            <div className="px-5 pb-3.5 pt-2.5 flex-grow ">
                ...
                <h4 className="font-danaMedium h-16 line-clamp-2 text-zinc-700 dark:text-white mb-2.5">
                    <a href="https://sabzlearn.ir/course/java-script-zero-to-hero/#lessons">{course.course.name}</a>
                </h4>
                {/* Course Footer */}
         ...
         <div class="bg-primary h-2 rounded-full" style={{width: `${randomNumber}%`}}></div>
                 </div>
	            </div>
            </div>
        </div>
